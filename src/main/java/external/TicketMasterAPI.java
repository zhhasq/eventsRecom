...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "byEHkeCqALp3GlXJHXQJDmRsnQePf8HA";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		String query = String.format("apikey=%s&latlong=%s,%s&keyword=%s&radius=%s", API_KEY, lat,lon,keyword,50,1);
		...
		try{
			...
			System.out.println("Sending requestion to url:" + url);
	...
	public static void main(String[] args) {
		...
		tmpAPI.queryAPI(29.682684, -95.29541);
	}
}
